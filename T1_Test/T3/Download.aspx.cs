    ...
    public partial class Download : Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            string filename = Server.MapPath("Files/" + "Tulips.jpg");
        ...
        {
            //using System.IO;
            string fileName = "Tulips.jpg";//客户端保存的文件名
            string filePath = Server.MapPath("Files/" + fileName);//路径
        ...
        {
            string fileName = "Koala.jpg";//客户端保存的文件名
            string filePath = Server.MapPath("/Files/" + fileName);//路径
